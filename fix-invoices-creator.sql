-- اصلاح created_by_user_id للفواتير
-- نفذ هذا SQL في Supabase

-- تحديث created_by_user_id للفواتير من أوامر البيع
UPDATE invoices i
...
-- تحديث created_by_user_id للفواتير المستقلة (استخدام أول مستخدم في الشركة)
UPDATE invoices i
