...
async function testFilter() {
  ...
  const copy = { ...orig };
  copy.id = testId;
  copy.event_key = 'test_copy_ref_' + testId;
  copy.reference_type = 'test'; // Modify reference type!
  ...
  console.log('Copy with reference_type=test Found?:', res.data?.some(x => x.id === testId));
