...
async function testFilter() {
  ...
  await s.from('notifications').insert({
    ...
    title: 'Test Created By Set',
    event_key: 'test_cb_' + testId,
    created_by: accountantId // SET THIS TO A VALID USER ID!
  });
  ...
  console.log('Accountant with created_by set Found:', res1.data?.some(x => x.id === testId));
