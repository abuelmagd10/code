...
async function testFilter() {
  ...
  const copy = { ...orig };
  copy.id = testId;
  copy.event_key = 'test_copy_cb_set_' + testId;
  copy.created_by = accountantId; // SET created_by to SOMEONE ELSE
  ...
  console.log('Copy with created_by=accountant Found?:', res.data?.some(x => x.id === testId));
