...
//      اعتماد) ⇒ التصنيع صفر. والباقى **٢٢ حدثاً** بـ**٤٥ نسخة زائدة** فى
//      الجرس، فى: الفواتير، الحجوزات، اعتماد الدفعات، طلبات ردّ العميل.
//      كلها تُرسل داخل حلقة بمتغيّر داخل خدمات المبيعات والمالية، وإصلاحها
//      يمسّ تلك الخدمات ⇒ بند مستقل يُقرَّر لا يُخمَّن.
const BASELINE = Number(process.env.DUP_NOTIFY_BASELINE ?? 22)
