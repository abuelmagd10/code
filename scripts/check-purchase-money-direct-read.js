...
const CONVERTED = [
  ...
  // v3.74.946 — الدفعة السادسة: صندوقُ الاعتمادات. أخطرُ ما فيه أن المالَ
  // يُبنى داخل **نصوصٍ مركَّبة** يوقّع عليها المعتمِد، فـ«0.00» كاذبةٌ هناك
  // أسوأُ منها فى عمود.
  "app/approvals/page.tsx",
  // v3.74.949 — شاشةُ المدفوعات، بعد أن أُغلقت آخرُ قراءتين فيها. وسبقتها
  // بوابةُ 947 لأن تخصيصَ الدفعة كان يُقاس فى المتصفح: **يُؤمَّن المستند،
  // ثم يُخفى المال.**
