-- =====================================================
-- إصلاح مباشر للفواتير المتبقية بدون قيود محاسبية
-- =====================================================
-- هذا السكريبت يستخدم INSERT مباشر بدلاً من DO block لتجنب مشاكل التنفيذ

-- 1. إنشاء قيود محاسبية للفواتير المتبقية
...
-- 2. إنشاء سطور القيود المحاسبية (Debit: Inventory/Expense)
...
-- 3. إنشاء سطور القيود المحاسبية (Debit: VAT Input)
INSERT INTO journal_entry_lines (
  journal_entry_id,
  account_id,
  debit_amount,
...
-- 4. إنشاء سطور القيود المحاسبية (Debit: Shipping)
INSERT INTO journal_entry_lines (
  journal_entry_id,
  account_id,
  debit_amount,
...
-- 5. إنشاء سطور القيود المحاسبية (Credit: Accounts Payable)
INSERT INTO journal_entry_lines (
  journal_entry_id,
  account_id,
  debit_amount,
