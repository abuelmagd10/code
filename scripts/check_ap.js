...
async function main() {
  ...
  for (const line of lines) {
    // AP is a liability account. Credit increases it, Debit decreases it.
    totalAP += (line.credit_amount - line.debit_amount);
  }
  
  console.log('Total AP Balance from GL:', totalAP);
}
