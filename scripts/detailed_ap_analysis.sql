-- =====================================================
-- تحليل تفصيلي لحساب الموردين (AP)
-- =====================================================

-- 1. إجمالي Credit من قيود فواتير الشراء (Bill)
SELECT 
  'Bill Journal Credits' AS check_type,
...
SELECT 
  'Bill Payment Debits' AS check_type,
...
-- 3. إجمالي Credit من قيود إشعارات الدائن (vendor_credit)
SELECT 
  'Vendor Credit Debits' AS check_type,
...
SELECT 
  'Bills Without Journals' AS check_type,
