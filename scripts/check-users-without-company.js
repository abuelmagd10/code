...
const KNOWN = new Set([
  // v3.74.857 — أُزيل من هنا `maxaboelmagd@gmail.com` (جريس تاون للمقاولات)
  // بعد أن أكّدنا على الإنتاج أنه صار **مالكاً** لشركة مكتملة (٩٥ حساباً،
  // فرع، مخزن، ١٢ فترة محاسبية). بقاء الاستثناء بعد زوال سببه ثقبٌ دائم:
  // لو تعثّر حسابه غداً لتجاهله هذا الفحص بصمت.
  // ⇒ القاعدة: الاستثناء يُكتب بسببه، ويُحذف بزوال سببه.
