...
BEGIN
  ...
  RAISE NOTICE '========================================';
  RAISE NOTICE 'Delete All Depreciation Journals';
  RAISE NOTICE 'حذف جميع القيود المرتبطة بالإهلاك';
  RAISE NOTICE '========================================';
  RAISE NOTICE 'Company: % (ID: %)', v_company_name, v_company_id;
  RAISE NOTICE '';

  -- =====================================
  -- 1. جمع جميع الأصول المرتبطة بالإهلاك
  -- =====================================
  ...
  RAISE NOTICE '✓ Reset journal_entry_id in depreciation schedules';
  RAISE NOTICE '✓ Changed posted schedules back to approved status';

  -- =====================================
  -- 6. إعادة حساب accumulated_depreciation و book_value للأصول
  -- =====================================
  -- إعادة تعيين القيم بناءً على جداول الإهلاك المتبقية
