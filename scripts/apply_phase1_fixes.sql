...
-- التحذير: تأكد من عمل نسخة احتياطية قبل التطبيق!
...
-- =============================================
\echo 'Applying: Journal Entry Balance Check...'
...
\echo '✓ Journal Entry Balance Check applied successfully'

-- =============================================
-- 2. منع تعديل الفواتير بعد إنشاء قيود محاسبية
-- =============================================
\echo 'Applying: Prevent Invoice Edit After Journal...'
...
\echo '✓ Prevent Invoice Edit After Journal applied successfully'

-- =============================================
-- 3. منع خروج مخزون بدون فاتورة
-- =============================================
\echo 'Applying: Inventory Sale Reference Constraint...'
...
\echo '✓ Inventory Sale Reference Constraint applied successfully'

-- =============================================
-- 4. منع حركات مخزون للفواتير الملغاة
-- =============================================
\echo 'Applying: Prevent Inventory for Cancelled Invoices...'
...
\echo '✓ Prevent Inventory for Cancelled Invoices applied successfully'
...
\echo ''
\echo '============================================='
\echo 'Phase 1 Critical Fixes Applied Successfully!'
\echo '============================================='
