...
-- للاطلاع فقط (Read-only) - متاحة لجميع الأدوار في الشركة
-- 
-- ⚠️ ملاحظة مهمة: هذه الصفحة استثناء من نظام الصلاحيات
-- الصفحة متاحة لجميع الأعضاء في الشركة بدون الحاجة لصلاحيات
