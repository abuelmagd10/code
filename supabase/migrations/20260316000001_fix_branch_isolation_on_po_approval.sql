-- Migration: Fix Branch Isolation for Global Roles on PO Approval/Rejection
-- Description: Updates the approve_purchase_order_atomic RPC to allow admins, owners, and gms to bypass branch isolation checks.
