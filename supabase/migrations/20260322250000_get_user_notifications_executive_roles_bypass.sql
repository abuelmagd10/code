-- ==============================================================================
-- توسيع تجاوز فلتر الفرع/المخزن في get_user_notifications ليشمل أدواراً مسجّلة
-- بصيغ مختلفة (gm, super_admin, …) حتى تصل إشعارات assigned_to_user للإدارة العليا
-- حتى عندما يكون على الإشعار branch_id لفرع آخر عن جلسة المستخدم.
-- ==============================================================================
...
COMMENT ON FUNCTION public.get_user_notifications(uuid, uuid, uuid, uuid, character varying, character varying, character varying, text, character varying, character varying) IS
  'Lists notifications; executive roles (owner, admin, general_manager, gm, super_admin, …) bypass branch/warehouse filters.';
