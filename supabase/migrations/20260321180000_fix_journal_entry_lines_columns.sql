-- ================================================================
-- Fix: Remove non-existent columns from journal_entry_lines INSERT
--      Columns removed: original_debit, original_credit, original_currency,
...
BEGIN
  ...
  -- Validate items (only for immediate execution)
  ...
  -- Only using confirmed columns: journal_entry_id, account_id, debit_amount,
  -- credit_amount, description, branch_id, cost_center_id
