-- ==============================================================================
-- 064: Fix Duplicate Notifications for Top Management
-- الوصف: إزالة التجاوز الشامل لفلتر الأدوار للإدارات العليا لمنع تكرار الإشعارات
-- ==============================================================================
...
BEGIN
  ...
  WHERE n.company_id = p_company_id
    -- Baseline Role/User Access Check: إلغاء التجاوز الشامل والأبقاء على المطابقة الدقيقة
    AND (
