-- Migration: Fix Audit Logs Columns on PO Approval/Rejection
-- Description: Updates the approve_purchase_order_atomic RPC to use the correct columns in the audit_logs table.
...
BEGIN
    ...
    -- 7. Audit Logging Fix (Using correct schema column names)
