-- Migration: Fix Enterprise ERP Product Creation RPC Signature
-- Date: 2026-03-08
-- Description: Drops the previous flawed function and creates the correct one without invalid columns.

-- Drop the old function with the incorrect signature
DROP FUNCTION IF EXISTS create_product_atomic(UUID, TEXT, TEXT, TEXT, NUMERIC, NUMERIC, TEXT, NUMERIC, NUMERIC, TEXT, UUID, UUID, TEXT, UUID, UUID, UUID, NUMERIC, NUMERIC, TEXT, NUMERIC);
