-- Migration: Auto Approve Generated Bill on PO Approval
-- Description: Updates the approve_purchase_order_atomic RPC so that the generated bill automatically inherits the approved status of the PO.
...
BEGIN
    ...
    IF p_action = 'approve' THEN
        v_new_status := 'approved'; -- Change from pending_approval to approved
        ...
        -- Auto-Create Draft Bill (Set to Approved since PO was just approved)
        ...
        INSERT INTO public.bills (
            ...
            approved_by,        -- Set TM user
            approved_at,        -- Set approval time
            created_at,
            is_deleted,
            purchase_order_id,
            branch_id,
            ...
            v_po.tax_amount,
            v_po.total_amount,
            'approved',         -- Automatically approved because PO is approved
            'approved',         -- Financial approval granted
            p_user_id,          -- TM user ID who clicked approve on the PO
            NOW(),
            NOW(),
            false,
            v_po.id,
