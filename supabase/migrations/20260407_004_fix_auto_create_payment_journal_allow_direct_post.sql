-- =============================================================================
-- Migration: 20260407_004_fix_auto_create_payment_journal_allow_direct_post.sql
-- Purpose : Allow automatic payment journal creation to complete under the
--           journal direct-post guard by toggling app.allow_direct_post during
...
COMMENT ON FUNCTION public.auto_create_payment_journal() IS
  'Creates automatic journal entries for positive payments and temporarily enables app.allow_direct_post so the draft-to-posted transition works under journal integrity guards.';
