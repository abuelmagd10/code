-- =============================================================================
-- Migration: 20260407_003_fix_post_accounting_event_allow_direct_post.sql
-- Purpose : Allow the legacy atomic accounting RPC to post journal entries
--           through the guarded production path without hitting
--           DIRECT_POST_BLOCKED.
-- =============================================================================
  ...
  IF p_payments IS NOT NULL AND jsonb_array_length(p_payments) > 0 THEN
    ...
    LOOP
      INSERT INTO payments (
        ...
        COALESCE((v_pay->>'id')::UUID, gen_random_uuid()),
  ...
  IF p_journal_entries IS NOT NULL AND jsonb_array_length(p_journal_entries) > 0 THEN
    ...
    LOOP
      INSERT INTO journal_entries (
        ...
        COALESCE((v_je->>'id')::UUID, gen_random_uuid()),
