-- Migration: Fix COALESCE Type Mismatch on PO Approval
-- Description: Updates the approve_purchase_order_atomic RPC to fix a type mismatch when generating the new bill number.
