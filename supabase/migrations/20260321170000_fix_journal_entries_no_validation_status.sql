-- ================================================================
-- Fix: Remove validation_status from process_purchase_return_atomic
--      This column does not exist in the journal_entries table
-- ================================================================
...
BEGIN
  ...
  -- Journal entry (draft when pending) — NO validation_status column
  ...
  -- IMPORTANT: status = 'pending_approval' so approve_purchase_return_atomic can act on it
