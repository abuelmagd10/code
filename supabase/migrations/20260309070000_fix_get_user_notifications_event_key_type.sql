-- Fix get_user_notifications return type for event_key
-- The event_key column in notifications table is TEXT, but the function returns character varying
-- This causes a type mismatch error (42804)
...
RETURNS TABLE(
  ...
  event_key text  -- Changed from character varying to text to match table column type
)
LANGUAGE plpgsql
SECURITY DEFINER
AS $function$
...
BEGIN
  ...
  SELECT
    ...
    n.event_key::TEXT  -- Explicit cast to TEXT to match return type
