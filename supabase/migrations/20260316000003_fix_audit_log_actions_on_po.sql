-- Migration: Fix Audit Logs Actions Constraint on PO Approval/Rejection
-- Description: Updates the approve_purchase_order_atomic RPC to use allowed actions ('APPROVE' and 'UPDATE') that satisfy the audit_logs_action_check check constraint.
...
BEGIN
    ...
    -- 7. Audit Logging Fix (Using correct schema column names and allowed actions)
