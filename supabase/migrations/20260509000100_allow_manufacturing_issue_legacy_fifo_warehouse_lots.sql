-- ==============================================================================
-- Manufacturing material issue FIFO legacy warehouse fix
-- Purpose:
--   Allow production issue FIFO consumption to use legacy FIFO cost lots where
--   warehouse_id is NULL, as long as company/product/branch match. Some purchase
--   flows created valid FIFO layers before warehouse_id was populated on lots.
-- ==============================================================================
    ...
    FOR v_fifo_lot IN
      SELECT *
       ...
       WHERE company_id = p_company_id
         ...
         AND COALESCE(warehouse_id, v_requirement.warehouse_id) = v_requirement.warehouse_id
