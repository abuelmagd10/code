-- ================================================================
-- Fix: Expand audit_logs_action_check to include purchase return actions
--      Then update approve_purchase_return_atomic and reject_warehouse_return
--      to use the correct action values
-- ================================================================

-- 1. Expand the action constraint
...
-- 2. Fix approve_purchase_return_atomic
