                    ...
                    <Card className="dark:bg-slate-900 dark:border-slate-800">
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                {drawing.journal_entries?.entry_number && (
                                    <div>
                                        <Label className="text-muted-foreground">{appLang === 'en' ? 'Journal Entry' : 'رقم القيد'}</Label>
                                        <p><Link href={`/journal-entries/${drawing.journal_entry_id}`} className="text-blue-600 hover:underline">{drawing.journal_entries.entry_number}</Link></p>
                                    </div>
                                )}
                            </div>
                            {drawing.description && (
