...
const errorTexts = {
  ar: {
    title: 'حدث خطأ في صفحة الإعدادات',
    description: 'نأسف لحدوث هذا الخطأ أثناء تحميل صفحة الإعدادات. يمكنك محاولة التالي:',
  ...
  en: {
    title: 'Settings Page Error Occurred',
    description: 'We apologize for this error while loading the settings page. You can try the following:',
    refresh: 'Try Again',
...
export default function SettingsError({ error, reset }: SettingsErrorProps) {
  useEffect(() => {
    console.error('Settings error occurred:', error)
