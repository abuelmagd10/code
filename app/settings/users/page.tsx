...
export default function UsersSettingsPage() {
  ...
  const resourceCategories = {
    ...
    purchases: {
      ...
      resources: [
        ...
        { value: 'purchase_requests', label: 'طلبات الشراء' },
        { value: 'purchase_orders', label: 'أوامر الشراء' },
        { value: 'goods_receipts', label: 'إيصالات الاستلام' },
  ...
  const defaultSidebarResourcesByRole: Record<string, string[]> = {
    ...
    accountant: [
      'dashboard', 'reports', 'invoices', 'customers', 'sales_returns', 'customer_debit_notes', 'bills', 'suppliers', 'purchase_requests', 'purchase_orders', 'goods_receipts', 'purchase_returns', 'vendor_credits', 'payments', 'expenses', 'drawings', 'journal_entries', 'chart_of_accounts', 'banking', 'annual_closing', 'accounting_periods', 'shareholders', 'fixed_assets', 'asset_categories', 'fixed_assets_reports', 'taxes', 'exchange_rates', 'accounting_maintenance', 'products', 'inventory', 'inventory_transfers', 'write_offs', 'third_party_inventory', 'product_availability', 'inventory_goods_receipt'
    ],
    store_manager: [
      'dashboard', 'products', 'inventory', 'product_availability', 'inventory_transfers', 'third_party_inventory', 'write_offs', 'inventory_goods_receipt', 'purchase_requests', 'purchase_orders', 'goods_receipts', 'sales_orders', 'shipping'
    ],
    staff: [
