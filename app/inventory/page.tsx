    ...
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-950 dark:to-slate-900">
      ...
      <main className="flex-1 md:mr-64 p-3 sm:p-4 md:p-8 pt-20 md:pt-8 overflow-x-hidden">
        <div className="space-y-4 sm:space-y-6 max-w-full">
          ...
          <ERPPageHeader
            title={appLang === 'en' ? 'Inventory' : 'المخزون'}
            description={appLang === 'en' ? 'Track inventory movements and stock levels' : 'تتبع حركات المخزون ومستويات المخزون'}
            variant="list"
            lang={appLang}
            extra={
              (userContext && !isAdmin) ? (
          ...
          {/* 🔐 Branch + Warehouse Filters - منفصلة عن الـ Header */}
