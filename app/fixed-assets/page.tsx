                ...
                <Button
                  ...
                  onClick={async () => {
                    try {
                      ...
                      if (response.ok) {
                        toast({ title: appLang === 'en' ? 'Database fixes applied successfully!' : 'تم تطبيق إصلاحات قاعدة البيانات بنجاح!' })
                        loadData() // Reload data
                      } else {
                        const error = await response.json()
                        toast({
                          title: appLang === 'en' ? 'Failed to apply fixes' : 'فشل في تطبيق الإصلاحات',
                          variant: 'destructive'
                        })
                      }
                    } catch (error) {
                      toast({
                        title: appLang === 'en' ? 'Error applying fixes' : 'خطأ في تطبيق الإصلاحات',
                        variant: 'destructive'
                      })
                    }
                  }}
