...
export default function NewExpensePage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // v3.74.641 — استثناء المالك الوحيد: إذا كان المُنشئ هو صاحب الصلاحية العليا
      // الوحيد في الشركة، يُعتمد المصروف تلقائياً (فصل المهام بلا معنى لشخص واحد).
      // وإلا يدخل دورة الاعتماد المعتادة (مسودة ← بانتظار الاعتماد).
      ...
      const insertData = {
        ...
        status: soleSenior ? "approved" : "draft",
        approval_status: soleSenior ? "approved" : "pending",
        approved_by: soleSenior ? userId : null,
        approved_at: soleSenior ? nowIso : null,
        created_by: userId,
