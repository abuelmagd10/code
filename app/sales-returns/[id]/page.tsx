...
export default function SalesReturnDetailPage() {
  ...
  if (!returnData) return <div className="flex min-h-screen"><main className="flex-1 md:mr-64 p-3 sm:p-4 md:p-8 pt-20 md:pt-8">{appLang === 'en' ? 'Return not found' : 'المرتجع غير موجود'}</main></div>
