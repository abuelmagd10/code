/**
 * 🔒 API أوامر الشراء مع نظام التحكم في الرؤية الموحد
 * 
 * GET /api/purchase-orders - جلب أوامر الشراء مع تطبيق قواعد الرؤية
 */
 ...
 * جلب أوامر الشراء مع تطبيق قواعد الرؤية
 */
export async function GET(request: NextRequest) {
  try {
    ...
    query = await applyDataVisibilityFilter(supabase, query, "purchase_orders", user.id, companyId)
