...
export async function POST(
  ...
  try {
    ...
    const result = await service.approveIntercompanyTransaction(
      id,
    ...
    return serverError(`Failed to approve intercompany transaction: ${error?.message || "unknown_error"}`)
  }
}
