...
export async function POST(
  ...
  try {
    ...
    const result = await service.submitIntercompanyTransaction(
      id,
    ...
    return serverError(`Failed to submit intercompany transaction: ${error?.message || "unknown_error"}`)
  }
}
