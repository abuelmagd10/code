...
const COPY = {
  ar: {
    ...
    detail: {
      ...
      tabsMaterialIssue: "صرف المواد",
      tabsProductReceive: "استلام المنتج",
      ...
      noOperationsDescription: "مسار التشغيل المختار لا يحتوي على عمليات معرّفة. يرجى الذهاب إلى صفحة مسارات التصنيع وإضافة عمليات للإصدار المختار، ثم العودة هنا وضغط «إعادة بناء مراحل الإنتاج».",
      noOperationsReleaseBlocked: "لا يمكن إصدار الأمر — يجب أن يحتوي مسار التشغيل على عملية واحدة على الأقل.",
      ...
      materialIssueDescription: "اطلب اعتماد صرف المواد من مسؤول المخزن. بعد الموافقة سيبدأ تنفيذ الأمر تلقائياً.",
  ...
  en: {
    ...
    detail: {
      ...
      materialIssueDescription: "Request material issue approval from the warehouse manager. Approval automatically starts the order.",
