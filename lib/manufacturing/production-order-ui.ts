...
const COPY = {
  ar: {
    ...
    detail: {
      ...
      draftSectionTitle: "بيانات الأمر القابلة للتعديل",
      draftSectionDescription:
        "يمكن تعديل هذه الحقول أثناء مرحلة المسودة. أي تغييرات على مسار التشغيل أو الكمية أو إعادة بناء العمليات تتم من خيار 'إعادة توليد العمليات'.",
      sourceSectionTitle: "المراجع التشغيلية",
      sourceSectionDescription: "هيكل المواد ومسار التشغيل ثابتان بعد الإصدار، وتظهر هنا كما هي مسجلة في قاعدة البيانات.",
      lifecycleSectionTitle: "سجل الأحداث",
      lifecycleDescription: "يعرض تواريخ بدء التنفيذ والإكمال والإلغاء عندما تكون متاحة.",
      operationsSectionTitle: "لقطة العمليات التنفيذية",
      operationsSectionDescription:
        "يعرض هذا الجدول العمليات التنفيذية المخططة. بعد الإصدار تصبح البنية للقراءة فقط، ويمكن فقط تحديث تقدّم كل عملية.",
      ...
      dialogs: {
        regenerateTitle: "إعادة توليد العمليات التنفيذية",
        regenerateDescription:
          "يُستخدم هذا الخيار أثناء مرحلة المسودة فقط، ويمكنك من خلاله تعديل الكمية المخططة أو مراجع هيكل المواد ومسار التشغيل قبل إعادة البناء.",
        releaseTitle: "تأكيد إصدار الأمر",
        releaseDescription: "سيتم التحقق من اكتمال بيانات الأمر. إذا لم تكن المستودعات أو العمليات مكتملة، سيُرفض الطلب.",
        startTitle: "بدء تنفيذ الأمر",
        startDescription: "سيتم نقل الأمر إلى حالة 'قيد التنفيذ' وتهيئة العمليات التنفيذية.",
        completeTitle: "إكمال أمر الإنتاج",
        completeDescription: "أدخل الكمية المنجزة الفعلية. سيتم التحقق من صحة البيانات قبل الإكمال.",
        cancelTitle: "إلغاء أمر الإنتاج",
        cancelDescription: "الإلغاء متاح فقط قبل بدء التنفيذ. يجب كتابة سبب واضح للإلغاء.",
        deleteTitle: "حذف أمر الإنتاج",
        deleteDescription: "الحذف متاح فقط في مرحلة المسودة. سيتم حذف الأمر وجميع العمليات المرتبطة به نهائيًا.",
        progressTitle: "تحديث تقدّم العملية",
        progressDescription:
          "يمكنك من خلال هذه الشاشة تحديث حالة العملية والكمية المنجزة فقط. لا يمكن تعديل بنية العمليات بعد الإصدار.",
      },
    },
    common: {
      noValue: "—",
      ...
      draftOnly: "متاح في مرحلة المسودة فقط",
      idOnlyHint: "يُرجى إدخال البيانات من صفحات التفاصيل المقابلة.",
      partialProgress: "يدعم تحديث تقدّم جزئي لكل عملية مع إمكانية إبقائها قيد التنفيذ.",
      operationCodeName: "الكود / الاسم",
      bomRouting: "هيكل المواد / مسار التشغيل",
      actualWindow: "نافذة التنفيذ الفعلي",
      actualStart: "بدء فعلي",
      actualEnd: "انتهاء فعلي",
      sourceOperation: "مصدر العملية (مسار التشغيل)",
