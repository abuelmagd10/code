  ...
  async recordTransfer(
    ...
    try {
      ...
      if (journalEntryId) {
        ...
        await rollbackJournalEntry(this.adminSupabase as any, journalEntryId, "bank transfer")
      }
      if (traceId) {
        await purgeTrace(this.adminSupabase, traceId, "bank-transfer-command.service")
      }
      throw error
    }
  }
