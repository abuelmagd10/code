  ...
  return (
    <section className="relative pt-28 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-cyan-500/10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-start">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold mb-6 leading-tight">
              <span className="block text-gray-900 dark:text-white">
                {t('نظام إدارة موارد المؤسسات', 'Enterprise Resource Planning')}
              </span>
            ...
            <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              {t(
                'منصة محاسبية وإدارية متكاملة تدعم تعدد الشركات والفروع والعملات، مع حوكمة صارمة وأمان مؤسسى وتوافق كامل مع المعايير المحاسبية الدولية.',
                'Integrated accounting & management platform with multi-company, multi-branch, multi-currency support — enterprise security, strict governance, and full IFRS/IAS compliance.'
              )}
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
              <Link href="/auth/sign-up" className="group inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 hover:-translate-y-0.5 transition-all">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-sm text-gray-600 dark:text-gray-400">
              <div className="flex items-center gap-2">
                ...
                <span>{t('بدون بطاقة ائتمان', 'No credit card')}</span>
              </div>
              <div className="flex items-center gap-2">
                <Globe2 className="w-4 h-4 text-blue-500" />
                <span>{t('دعم عربى/إنجليزى', 'Arabic/English')}</span>
              </div>
              <div className="flex items-center gap-2">
                <Sparkles className="w-4 h-4 text-purple-500" />
                <span>{t('AI Copilot', 'AI Copilot')}</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative hidden lg:block">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-blue-500/20 border border-gray-200 dark:border-gray-700 backdrop-blur">
              {/* Browser chrome */}
              <div className="flex items-center gap-2 px-4 py-3 bg-gray-100 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                ...
                <div className="flex-1 mx-3">
                  <div className="px-3 py-1 rounded text-xs text-gray-500 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                    7esab.com/dashboard
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-950">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg p-4 mb-3 border border-gray-200 dark:border-gray-700">
                  ...
                  <svg viewBox="0 0 240 80" className="w-full h-20">
                    ...
                    <path d="M0,60 L20,55 L40,45 L60,50 L80,30 L100,35 L120,20 L140,25 L160,15 L180,20 L200,10 L220,15 L240,5 L240,80 L0,80 Z" fill="url(#chartGrad)" />
                ...
                <div className="flex items-center gap-2 text-xs">
                  {['USD 31.20', 'EUR 33.85', 'GBP 39.42', 'SAR 8.31'].map((c) => (
                    <div key={c} className="flex-1 px-2 py-1.5 rounded bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-center text-gray-700 dark:text-gray-300">
                      {c}
                    </div>
                  ))}
                </div>
            ...
            {/* Floating badges */}
            <div className="absolute -top-3 -right-3 px-3 py-1.5 rounded-full bg-gradient-to-r from-purple-600 to-pink-600 text-white text-xs font-bold shadow-lg animate-bounce">
              IAS 21 ✓
            </div>
            <div className="absolute -bottom-3 -left-3 px-3 py-1.5 rounded-full bg-gradient-to-r from-green-500 to-emerald-500 text-white text-xs font-bold shadow-lg">
              {t('متعدد العملات', 'Multi-Currency')}
            </div>
          </div>
        </div>
      </div>
