  ...
  return (
    <section className="relative pt-28 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute bottom-10 -left-32 w-96 h-96 bg-purple-500/20 rounded-full blur-3xl animate-pulse" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-start">
            <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 rounded-full bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20">
              ...
              <span className="text-sm font-medium text-blue-600 dark:text-blue-400">{t('Enterprise ERP جاهز للإنتاج · IAS 21 Compliant','Enterprise ERP — Production Ready · IAS 21 Compliant')}</span>
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold mb-6 leading-tight">
              ...
              <span className="block mt-2 bg-gradient-to-r from-blue-600 via-cyan-500 to-purple-600 bg-clip-text text-transparent">{t('بمعايير عالمية','World-Class Standard')}</span>
            </h1>
            <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">{t('منصة محاسبية وإدارية متكاملة تدعم تعدد الشركات والفروع والعملات، مع حوكمة صارمة وأمان مؤسسى.','Integrated platform with multi-company, multi-branch, multi-currency support.')}</p>
